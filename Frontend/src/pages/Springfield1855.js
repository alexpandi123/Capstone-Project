...
const Springfield1855Page = () => {
    ...
    const fetchData = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c039c8a597d34c6d8694ba")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">Springfield Model 1855</h1>
            <h6 className="subtitle_text text-center mb-5"> </h6>
