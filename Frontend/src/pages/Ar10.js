...
const Ar10Page = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c037bea597d34c6d8694b4")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">AR-10</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "ArmaLite AR-10"</h6>
