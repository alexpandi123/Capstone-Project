...
const Hecklerkochg11Page = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c03ead6f4695cee7a644db")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">G11 K2</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Heckler & Koch G11"</h6>
