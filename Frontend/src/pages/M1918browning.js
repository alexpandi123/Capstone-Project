...
const M1918browningPage = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c03733a597d34c6d8694b1")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">M1918A2 BAR</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Browning Automatic Rifle"</h6>
