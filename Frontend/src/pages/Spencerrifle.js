...
const SpencerriflePage = () => {
    ...
    const fetchData = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c03c1e6f4695cee7a644cb")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">M1865 Spencer Rifle</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Spencer repeating rifle"</h6>
