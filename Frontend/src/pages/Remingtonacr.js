...
const RemingtonacrPage = () => {
    ...
    const fetchData = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c03ceb6f4695cee7a644d0")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">Remington ACR</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Adaptive Combat Rifle"</h6>
