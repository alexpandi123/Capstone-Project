...
const Fnf2000Page = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c03e3b6f4695cee7a644d9")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">FN F2000</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "F2000 S"</h6>
