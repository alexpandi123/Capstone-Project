...
const Xm29oicwPage = () => {
    ...
    const fetchData = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c042a26f4695cee7a644e8")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">XM29 OICW</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Objective Individual Combat Weapon"</h6>
