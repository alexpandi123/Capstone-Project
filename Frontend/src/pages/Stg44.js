...
const Stg44Page = () => {
    ...
    const fetchData = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c0414a6f4695cee7a644e4")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">StG 44</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Sturmgewehr 44 (Assault Rifle 44)"</h6>
