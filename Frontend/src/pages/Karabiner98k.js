...
const Karabiner98kPage = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c03ac9a597d34c6d8694bd")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">Kar98k</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "The Karabiner 98 Kurz"</h6>
