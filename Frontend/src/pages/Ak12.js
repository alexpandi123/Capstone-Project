...
const Ak12Page = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c03d626f4695cee7a644d3")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">AK-12</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Avtomat Kalashnikova, 2012"</h6>
