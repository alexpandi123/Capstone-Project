...
const Remington95Page = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c03b75a597d34c6d8694c0")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">Remington 95</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Remington Model 95 Double Derringer"</h6>
