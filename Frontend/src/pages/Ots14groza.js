...
const Ots14grozaPage = () => {
    ...
    const fetchData = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64c041026f4695cee7a644e2")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">OTs-14 Groza</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "OTs-14-4 (Groza-4)"</h6>
