...
const M16Page = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64ac8b3abdb5a65bff108f2c")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">M-16</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Rifle, Caliber 5.56 mm, M16"</h6>
