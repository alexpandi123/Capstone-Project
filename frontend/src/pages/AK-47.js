...
const AK47Page = () => {
    ...
    const fetch9a91Data = () => {
        setIsLoading(true)
        fetch("http://localhost:3005/weapons/64aadb5dfad908e8073addac")
    ...
    return(
        <div className="main_div">
            ...
            <h1 className="title_text text-center mt-5">AK-47</h1>
            <h6 className="subtitle_text text-center mb-5">also known as "Avtomat Kalashnikova"</h6>
